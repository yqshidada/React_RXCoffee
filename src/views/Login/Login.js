  ...
  login() {
    ...
    this.$axios({
      ...
      if (res.data.code === 200) {
        ...
        this.$cookies.save('token', res.data.token, {expires});
      ...
      <div className="login">
        ...
        <div className="login-info">
          <div className="login-info-title">
            <div className="zh-title">欢迎回来</div>
            <div className="en-title">Please login in your account</div>
          </div>
          ...
          <div className="forgot">
            <div className="forgot-text">忘记密码？</div>
          </div>

          <div className="login-btn-box">
            <Btn click={this.login.bind(this)} bgColor="#0C34BA" color="#fff" block round>登录</Btn>
          </div>

          <div className="register-btn-box">
            <Btn block round outline click={this.goPage.bind(this, '/register')}>注册</Btn>
          </div>
        </div>
      </div>
    )
